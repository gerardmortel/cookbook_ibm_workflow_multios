...
action :prepare do
  ...
  if ::File.exist?(install_prepare_done)
    ...
    converge_by("prepare_install #{@new_resource}") do
      ...
      # Download BAW source binaries
#      bearer = 'eyJraWQiOiIyMDE3MTEyOSIsImFsZyI6IlJTMjU2In0..HRSDs2NoPaktcn6w-xTdWItHmJqSvey6DDkyhHQuggwE5Qi0r9hxNZqQS-gRFAQ-MIGa0VOVJX6lIx7y3_HFUZWMYPPifhHmdL8rbI6rBTTR0-7EFmUuTasujufHw4y6ouWKXFwKVHKC7ZxU5XvAtgP7oTJUHBEoFoUXTLPhI-UqR8Clg3OPZVL0IePv7JF1Q9LWmkfkmaGqRQDBs6PiWRDR0rifq6HMcs8iW5l4EZzWeXqBNPdOmoJTHltTrh4EBj4DqAO7G-scOEogQNNECSB1rmYLkFa3FCS3hcbz4rdcD9uS8uwCnO93hNfNAnJoaklTR797PFQvEipD2KxyeQ'
      Chef::Log.info("Download BAW source binaries \n")
      execute "Download BAW source binaries" do
        #command "cd /root && wget --header 'Authorization: Bearer #{bearer}' --header 'ibm-service-instance-id: crn:v1:bluemix:public:cloud-object-storage:global:a/f530639ee58e0951691756db161f3c63:0cdf4287-40e7-4301-8410-e0d05836646a::' https://s3.private.us-east.cloud-object-storage.appdomain.cloud/baw/BAW_18.0.0.1LINX86_64BIT_ML_13.tar.gz && wget --header 'Authorization: Bearer #{bearer}' --header 'ibm-service-instance-id: crn:v1:bluemix:public:cloud-object-storage:global:a/f530639ee58e0951691756db161f3c63:0cdf4287-40e7-4301-8410-e0d05836646a::' https://s3.private.us-east.cloud-object-storage.appdomain.cloud/baw/BAW_18.0.0.1LINX86_64BIT_ML_23.tar.gz && wget --header 'Authorization: Bearer #{bearer}' --header 'ibm-service-instance-id: crn:v1:bluemix:public:cloud-object-storage:global:a/f530639ee58e0951691756db161f3c63:0cdf4287-40e7-4301-8410-e0d05836646a::' https://s3.private.us-east.cloud-object-storage.appdomain.cloud/baw/BAW_18.0.0.1LINX86_64BIT_ML_33.tar.gz"
        command 'cd /root && wget --header "Authorization: Bearer $bearer" --header "ibm-service-instance-id: crn:v1:bluemix:public:cloud-object-storage:global:a/f530639ee58e0951691756db161f3c63:0cdf4287-40e7-4301-8410-e0d05836646a::" https://s3.private.us-east.cloud-object-storage.appdomain.cloud/baw/BAW_18.0.0.1LINX86_64BIT_ML_13.tar.gz && wget --header "Authorization: Bearer $bearer" --header "ibm-service-instance-id: crn:v1:bluemix:public:cloud-object-storage:global:a/f530639ee58e0951691756db161f3c63:0cdf4287-40e7-4301-8410-e0d05836646a::" https://s3.private.us-east.cloud-object-storage.appdomain.cloud/baw/BAW_18.0.0.1LINX86_64BIT_ML_23.tar.gz && wget --header "Authorization: Bearer $bearer" --header "ibm-service-instance-id: crn:v1:bluemix:public:cloud-object-storage:global:a/f530639ee58e0951691756db161f3c63:0cdf4287-40e7-4301-8410-e0d05836646a::" https://s3.private.us-east.cloud-object-storage.appdomain.cloud/baw/BAW_18.0.0.1LINX86_64BIT_ML_33.tar.gz'
        action :run
      end
      ...
      im_archive_names.each_pair do |p, v|
        ...
        Chef::Log.info("#### I am here deleting #{repo_paths}/#{filename} using method 1 \n")
        file "#{repo_paths}/#{filename}" do
          action :delete
        end

	# Delete source binaries
        Chef::Log.info("#### I am here deleting #{filename} using method 2 \n")
	execute "Delete #{filename}" do
	  command "rm /root/#{filename}"
          action :run
	end
