...
action :create do
  if @current_resource.de_created
    ...
    converge_by("create #{@new_resource}") do
      ...
      cmd = "export LANG=en_US; export LANGUAGE=en_US; export LC_ALL=en_US; ulimit -n 65536; ./BPMConfig.sh -create -de #{silent_createde_propfile_abspath}" if (node['platform_family'] == "debian")
